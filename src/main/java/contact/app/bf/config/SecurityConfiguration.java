...
import contact.app.bf.security.*;
import contact.app.bf.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                authz
                    ...
                    .permitAll()
                    // 👉 Permet à Prometheus d'accéder sans authentification
                    .requestMatchers(mvc.pattern("/management/prometheus"))
                    .permitAll()
                    // Les autres endpoints management restent protégés
