...
import static contact.app.bf.domain.ContactAsserts.*;
...
class ContactResourceIT {
    ...
    void putExistingContact() throws Exception {
        ...
        updatedContact.nom(UPDATED_NOM).prenom(UPDATED_PRENOM).email(UPDATED_EMAIL).street(UPDATED_STREET).telephone(UPDATED_TELEPHONE);
    ...
    void partialUpdateContactWithPatch() throws Exception {
        ...
        partialUpdatedContact.nom(UPDATED_NOM).street(UPDATED_STREET);
